...
users = {
    'user1': {'username': 'Test413', 'password': 'test413'},
    'user2': {'username': 'admin', 'password': 'zxasqw1!'}
}
...
@app.route('/modifiedlogin', methods=['GET', 'POST'])
def weakpage():
    if request.method == 'POST':
    ...
    return render_template('modifiedlogin.html')


if __name__ == '__main__':
    app.run(debug=True, port=5413)
